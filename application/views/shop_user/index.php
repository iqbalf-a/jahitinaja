...
<div class="main">
        ...
        <div class="row margin-bottom-40">
          ...
          <div class="col-md-12 sale-product">
            ...
            <div class="owl-carousel owl-carousel5">
              <?php $i = 1; ?>
              <?php foreach ($list_all as $la) : ?>
              <div>
                <div class="product-item">
                  <div class="pi-img-wrapper">
                    <img src="<?= base_url('assets/img/products/').$la->product_img  ?>" class="img-responsive" alt="Berry Lace Dress">
                    <div>
                      <a href="<?= base_url('assets/img/products/').$la->product_img ?>" class="btn btn-default fancybox-button">Zoom</a>
                    </div>
                  </div>
                  <h3><a href="#"> <?= $la->product_name ?> </a></h3>
                  <div class=""> Penjahit: <?= $la->name ?> </div>
                  <div class="pi-price"> Rp. <?= $la->price ?> </div>
                  <a href="<?= base_url('shop_user/detailproduct/').$la->id ?>" class="btn btn-default add2cart">Tambah</a>
                </div>
              </div>
              <?php $i++; ?>
            <?php endforeach; ?>
              ...
              <div>
                <div>
                  <div class="product-item">
                    ...
                    <a href="javascript:;" class="btn btn-default add2cart">Tambah</a>
                  </div>
          ...
          <div class="col-md-6 two-items-bottom-items">
            ...
            <div class="owl-carousel owl-carousel2">
              ...
              <div>
                <div class="product-item">
                  <div class="pi-img-wrapper">
                    <img src="assets/img/products/contoh1.jpg" class="img-responsive" alt="Berry Lace Dress">
                    <div>
                      <a href="assets/img/products/contoh1.jpg" class="btn btn-default fancybox-button">Zoom</a>
                      <a href="#product-pop-up" class="btn btn-default fancybox-fast-view">Lihat</a>
                    </div>
                  </div>
                  <h3><a href="shop-item.html">Kemeja Batik2</a></h3>
                  <div class="pi-price">Rp. 300.000</div>
                  <a href="javascript:;" class="btn btn-default add2cart">Tambah</a>
                </div>
              </div>
    ...
    <?php
      ...
      echo 'Page generated in '.$total_time. ' second.';
     ?>
