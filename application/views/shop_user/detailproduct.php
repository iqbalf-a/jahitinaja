        ...
        <div class="row margin-bottom-40">
          ...
          <div class="col-md-9 col-sm-7">
            ...
            <div class="content-form-page">
              <form role="form" method="post" class="form-horizontal form-without-legend" action="<?= base_url('shop_user/buy/'.$product['id']); ?>">
                ...
                <div class="row">
                  <div class="col-lg-8 col-md-offset-2 padding-left-0 padding-top-20">
										<a href="<?= base_url('shop_user/buy/'.$product['id']); ?>"> <button type="submit" class="btn btn-primary" name="button"> TAMBAH </button> </a>
